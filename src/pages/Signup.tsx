      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-6"
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-xs mb-1.5" style={{ color: '#4a6a8a', fontFamily: 'DM Sans, sans-serif' }}>Email</label>
              <input
            ...
            <div>
              <label className="block text-xs mb-1.5" style={{ color: '#4a6a8a', fontFamily: 'DM Sans, sans-serif' }}>Password</label>
              <input
            ...
            <div>
              <label className="block text-xs mb-1.5" style={{ color: '#4a6a8a', fontFamily: 'DM Sans, sans-serif' }}>Confirm Password</label>
              <input
                ...
                style={{
                  ...inputStyle,
                  borderColor: confirmPassword && password !== confirmPassword ? 'rgba(255,77,109,0.4)' : 'rgba(0,229,196,0.15)',
                }}
                onFocus={(e) => e.target.style.borderColor = 'rgba(0,229,196,0.35)'}
                onBlur={(e) => e.target.style.borderColor = confirmPassword && password !== confirmPassword ? 'rgba(255,77,109,0.4)' : 'rgba(0,229,196,0.15)'}
              />
            </div>
