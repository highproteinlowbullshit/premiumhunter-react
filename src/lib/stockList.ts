...
export const STOCK_LIST: StockMeta[] = [
  ...
  { ticker: 'SMAR',  name: 'Smartsheet',                 sector: 'Technology'  },
  ...
  { ticker: 'NOVA',  name: 'Onto Innovation (Nova)',      sector: 'Technology'  },
  ...
  { ticker: 'DFS',   name: 'Discover Financial',         sector: 'Finance'     },
  ...
  { ticker: 'X',     name: 'United States Steel',        sector: 'Materials'   },
