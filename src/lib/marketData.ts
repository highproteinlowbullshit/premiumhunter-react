...
function buildScreenerFromLive(
  ...
  hv: { ivRank: number | null; ivPercentile: number; currentHV: number; hv30: number; hv52wkHigh: number; hv52wkLow: number; ivHvRatio: number | null; volume: number | null } | null,
